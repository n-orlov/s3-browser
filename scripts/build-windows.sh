...
# to create Windows installers without needing Wine on the host system.
#
...
echo "=== S3 Browser Windows Build (Docker) ==="
...
echo ""
echo "=== Build Complete ==="
echo "Windows installers are in: $PROJECT_DIR/release/"
